...
{
    /// <summary>Encapsula operações comuns do sistema de arquivos Windows.</summary>
    public static class FileSystemUtils
    {
        ...
        /// <summary>Apaga determinado arquivo baseado em um caminho específico.</summary>
        ...
        /// <summary>Encontra o endereço da pasta no sistema de arquivos.</summary>
        ...
        /// <summary>Retorna o caminho de uma pasta especial.</summary>
